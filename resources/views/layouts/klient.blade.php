...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/layout.css') }}?v=12">
...
<script src="{{ asset('js/imgw-map.js') }}?v=5"></script>
<script src="{{ asset('js/imgw-table.js') }}?v=4"></script>
<script src="{{ asset('js/client.js') }}?v=12"></script>
</body>
</html>
