@if(!empty($data['points']) || !empty($data['frames']))
    <div class="actualHeader imgw-map-header">
        <div class="imgw-map-header-side"></div>
        <div class="imgw-map-header-title">
            <span class="normal">Warunki atmosferyczne o godzinie <span class="hour" id="imgw-map-hour">{{ $data['actualHour'] }}</span></span>
        </div>
